    ...
    public void modifyKarte() {
        ...
        DBTask task = new DBTask<LetterModule,Void>(getContext()) {
            ...
            protected void succeeded(LetterModule lm) {
                ...
                sb.append(ClientContext.getMyBundle(Reply2Viewer.class).getString("modify")).append("(").append(editor.getTitle()).append(")");
    ...
    public void copyDocument() {
        ...
        DBTask task = new DBTask<LetterModule,Void>(getContext()) {
            ...
            protected void succeeded(LetterModule lm) {
                ...
                ChartImpl chart = (ChartImpl)getContext();
                StringBuilder sb = new StringBuilder();
                sb.append(ClientContext.getMyBundle(Reply2Viewer.class).getString("dupuricate")).append("(").append(editor.getTitle()).append(")");
                chart.addChartDocument(editor, sb.toString());
            }
        };
        task.execute();
