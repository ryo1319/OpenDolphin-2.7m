...
public final class InjectionEditor extends AbstractStampEditor {
    ...
    private static final String NO_CHARGE = "手技料なし";
...
////s.oh$
    ...
    public Object getValue() {
        ...
        if (view.getNoChargeChk().isSelected() && AbstractStampEditor.isInjection(test)) {
...
////s.oh$
        ...
        searchResultModel = new ListTableModel<TensuMaster>(SR_COLUMN_NAMES, 0, SR_METHOD_NAMES, null) {
