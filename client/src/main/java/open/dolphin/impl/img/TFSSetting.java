...
public class TFSSetting {
    ...
    private ActionMap getAction(ResourceBundle resource) {
        ...
        AbstractAction saveProperties = new AbstractAction(text) {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                // tfsServer
                setProperty("tfsServer", view.getTfsServerFld());
    ...
    public void start() {
        ...
        // TFS
        view.getTfsServerFld().setText(properties.getProperty("tfsServer"));
        ...
        dialog = jop.createDialog(parent, ClientContext.getFrameTitle("TFS設定"));
