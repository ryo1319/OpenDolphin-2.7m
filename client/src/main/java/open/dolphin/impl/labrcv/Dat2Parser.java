...
public class Dat2Parser implements LabResultParser {
    ...
    public List<NLaboImportSummary> parse(Path labFile) throws IOException {
        ...
        //SimpleDateFormat df16 = new SimpleDateFormat(DATE_FORMAT_16);

        BufferedReader reader = new BufferedReader(new InputStreamReader(Files.newInputStream(labFile),getEncoding()));
