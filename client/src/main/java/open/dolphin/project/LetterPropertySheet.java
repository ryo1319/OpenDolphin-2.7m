 ...
 *
 */
public class LetterPropertySheet extends AbstractPropertySheet { 
    
    // Target
    private SettingBean bean;
    
    public LetterPropertySheet() {
        super();
        String ID = "letterSetting";
        String TITLE = ClientContext.getMyBundle(LetterPropertySheet.class).getString("title.letter");
        String ICON = "icon_letter_settings_small";
        this.setId(ID);
        this.setTitle(TITLE);
        this.setIcon(ICON);
    }
