 ...
 *
 */
public class ClaimPropertySheet extends AbstractPropertySheet { 
    
    // Setting Bean
    private SettingBean bean;
    
    public ClaimPropertySheet() {
        super();
        String ID = "claimSetting";
        String TITLE = ClientContext.getMyBundle(ClaimPropertySheet.class).getString("title.receipt");
        String ICON = "icon_claim_settings_small";
        this.setId(ID);
        this.setTitle(TITLE);
        this.setIcon(ICON);
    }
